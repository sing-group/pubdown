...
/**
 * Utility class with several methods to compare objects
 */
public final class Compare {
	private Compare() {
	}

	public static <T> Builder<T> objects(final T obj1, final T obj2) {
	...
	public final static class Builder<T> {
		...
		public Builder(final T obj1, final T obj2) {
			this.obj1 = obj1;
			this.obj2 = obj2;
		}
		...
		private Builder<T> asComparables(final boolean reverseOrder) {
		...
		private <C extends Comparable<C>> Builder<T> by(final Function<T, C> f, final boolean reverseOrder) {
		...
		private Builder<T> byInt(final ToIntFunction<T> f, final boolean reverseOrder) {
			this.addComparisonBy((o1, o2) -> Integer.compare(f.applyAsInt(o1), (f.applyAsInt(o2))), reverseOrder);
		...
		private Builder<T> byLong(final ToLongFunction<T> f, final boolean reverseOrder) {
			this.addComparisonBy((o1, o2) -> Long.compare(f.applyAsLong(o1), (f.applyAsLong(o2))), reverseOrder);
		...
		private Builder<T> byFloat(final ToFloatFunction<T> f, final boolean reverseOrder) {
			this.addComparisonBy((o1, o2) -> Float.compare(f.applyAsFloat(o1), (f.applyAsFloat(o2))), reverseOrder);
		...
		private Builder<T> byDouble(final ToDoubleFunction<T> f, final boolean reverseOrder) {
			this.addComparisonBy((o1, o2) -> Double.compare(f.applyAsDouble(o1), (f.applyAsDouble(o2))), reverseOrder);
		...
		private <C extends Comparable<C>> Builder<T> byArray(final Function<T, C[]> f, final boolean reverseOrder) {
		...
		private Builder<T> byIntArray(final Function<T, int[]> f, final boolean reverseOrder) {
			this.addComparisonBy(nullSafeCompare(f, (a1, a2) -> {
				for (int i = 0; i < Math.max(a1.length, a2.length); i++) {
					final int index = i;
		...
		private Builder<T> byLongArray(final Function<T, long[]> f, final boolean reverseOrder) {
			this.addComparisonBy(nullSafeCompare(f, (a1, a2) -> {
				for (int i = 0; i < Math.max(a1.length, a2.length); i++) {
					final int index = i;
		...
		private Builder<T> byDoubleArray(final Function<T, double[]> f, final boolean reverseOrder) {
			this.addComparisonBy(nullSafeCompare(f, (a1, a2) -> {
				for (int i = 0; i < Math.max(a1.length, a2.length); i++) {
					final int index = i;
		...
		private Builder<T> byFloatArray(final Function<T, float[]> f, final boolean reverseOrder) {
			this.addComparisonBy(nullSafeCompare(f, (a1, a2) -> {
				for (int i = 0; i < Math.max(a1.length, a2.length); i++) {
					final int index = i;
	...
	public final static <T, C> ToIntBiFunction<T, T> nullSafeCompare(final Function<T, C> f,
			final ToIntBiFunction<C, C> cmp) {
		return (o1, o2) -> {
