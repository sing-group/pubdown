...
// * variable
// */
// public void setRobotFilterByNameDescriptionOwner(final String
// robotFilterByNameDescriptionOwner) {
...
// * variable
// */
// public void setRobotFilterByCategoryContentType(final String
// robotFilterByCategoryContentType) {
...
// em -> em.createQuery("SELECT u FROM User u ORDER BY u.login ASC",
...
// return tm.getInTransaction(
// em -> em.createQuery("SELECT r FROM Robot r ORDER BY r.user ASC, r.name ASC",
...
// return tm.getInTransaction(
// em -> em.createQuery("SELECT re FROM RobotExecution re ORDER BY re.userLogin
// ASC", RobotExecution.class)
// .getResultList());
// }
//
// /**
...
// public void newUser() {
// Executions.createComponents("userForm.zul", null, singletonMap("user", new
// User()));
// }
//
// /**
...
// Executions.createComponents("userForm.zul", null, singletonMap("user",
// user));
// }
//
// /**
...
// } else {
// Messagebox.show("You can't delete the actual user", "Information",
...
// final PasswordRecovery passwordRecovery = new
// PasswordRecovery(user.getLogin(), uuid);
//
// if (!isCurrentUser(user)) {
// if (!user.isLocked()) {
// Messagebox.show("Do you want to reset the user's password?", "Reset
// Password",
// new Messagebox.Button[] { Messagebox.Button.OK, Messagebox.Button.CANCEL },
// new String[] { "Confirm", "Cancel" }, Messagebox.QUESTION, null, event -> {
// switch (event.getName()) {
...
// em.persist(user);
// try {
// mailer.sendEmail("no_reply@jarvestweb.com", user.getEmail(), "Reset
// Password",
...
// }, singletonMap("width", "500"));
// } else {
// Messagebox.show("The user is locked, do you want to resend the email?",
// "Reset Password",
// new Messagebox.Button[] { Messagebox.Button.OK, Messagebox.Button.CANCEL },
// new String[] { "Confirm", "Cancel" }, Messagebox.QUESTION, null, event -> {
// switch (event.getName()) {
...
// }
// } else {
// Messagebox.show("You can't reset the password of the actual user",
...
// return new StringBuilder().append("<html>").append("<head><title>Reset
// Password</title></head>")
// .append("<body><br/><br/>").append(url +
// PASSWORD_RECOVERY_URL).append(uuid).append("</body>")
...
// return new StringBuilder().append("<html>").append("<head><title>Unlock
// User</title></head>")
// .append("<body><br/><br/>").append("<p>Your user has been
// unlocked</p>").append("</body>")
// .append("</html>").toString();
// }
//
// /**
...
// Executions.createComponents("robotForm.zul", null, singletonMap("robot", new
// RepositoryQuery()));
// }
//
// /**
...
// @Command
// @NotifyChange({ "robotsList" })
// public void editRobot(@BindingParam("currentRobot") final RepositoryQuery
// robot) {
// Executions.createComponents("robotForm.zul", null, singletonMap("robot",
// robot));
// }
//
// /**
...
// */
// @Command
// public void deleteRobot(@BindingParam("currentRobot") final RepositoryQuery
// robot) {
...
// */
// @GlobalCommand
// public void updateRobotList(@BindingParam("robot") final RepositoryQuery
// robot) {
...
// */
// @GlobalCommand
// public void deleteRobotFromUser(@BindingParam("robot") final RepositoryQuery
// robot) {
// robot.setUser(null);
// robotsList.remove(robot);
// robotsList = getAllRobots();
...
// public void updateExecutions(@BindingParam("task") final RobotExecutionTask
// task,
...
//
// @Command
// public void deleteResult(@BindingParam("currentResult") final RobotExecution
// robotExecution) {
...
//
// @Command
// public void abortExecution(@BindingParam("currentResult") final
// RobotExecution robotExecution) {
// final String userId = robotExecution.getUserLogin();
//
// Messagebox.show("Are you sure you want to abort the current execution?",
// "Abort execution",
...
// .createQuery("SELECT DISTINCT re.userLogin FROM RobotExecution re",
