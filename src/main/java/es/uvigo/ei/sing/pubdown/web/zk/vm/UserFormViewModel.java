...
// return isEmail(this.user.getEmail()) && !isEmpty(this.user.getLogin()) &&
// !isEmpty(this.user.getPassword())
...
// } else if (!email.equals(uneditedUser.getEmail()) &&
...
// } else if (!login.equals(uneditedUser.getLogin()) &&
...
// } else if (!apiKey.equals(uneditedUser.getApiKey()) &&
...
// if (isUserModified()) {
// tm.runInTransaction(em -> {
// final String command = checkIfLoginExists(this.user.getLogin()) ?
// "updateUserList" : "addUserList";
// final String updatePassword = BCrypt.hashpw(this.user.getPassword(),
// BCrypt.gensalt());
...
// try {
// tm.run(em -> em.createQuery("SELECT u FROM User u WHERE u.apiKey = :apiKey",
// User.class)
...
// try {
// tm.run(em -> em.createQuery("SELECT u FROM User u WHERE u.email = :email",
// User.class)
...
//
// BindUtils.postGlobalCommand(EventQueueUtils.QUEUE_NAME, null,
// "deleteRobotFromUser",
